Este repositório possui um estudo que faz parte do MVP da sprint de "Engenharia de Dados", da PUC-Rio, em dezembro de 2025. São armazenados dois arquivos:

1) Diagrama ER.jpg - Diagrama Entidade-Relacionamento (DER) do banco usado no estudo
2) MVP2_PZT_Engenharia de Dados.ipynb - relatório com os códigos, gráficos e reflexões da pesquisadora sobre os dados apresentados
