...
Diagrama ER.jpg - Diagrama Entidade-Relacionamento (DER) do banco usado no estudo
MVP_PZT_Engenharia de Dados.ipynb - relatório com os códigos, gráficos e reflexões da pesquisadora sobre os dados apresentados
