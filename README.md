...
Genero5.csv - dataset com os dados
MVP_PZT_EngenhariaDados.ipynb - relatório com os códigos, gráficos e reflexões da pesquisadora sobre os dados apresentados
